...
const PrivacyPolicyPage = () => {
  return (
    ...
    <div><br><span>Last Updated On 25-Aug-2023</span>
   <br><span>Effective Date 10-Aug-2023</span>
   </div>
   </h1>
...
<p class="privacy-policy-p">
    ...
    678930,
    American Samoa,
    email: haalah+45@mozilor.com,
    phone: 9876543210

    on the collection,
    use and disclosure of your information that we collect
    when you use our website ( https://created-gatsby-site.vercel.app ).
...
<ol class="privacy-policy-ol">
    ...
    <li>
        ...
        <p class="privacy-policy-p">
            ...
            <a href="https://created-gatsby-site.vercel.app/cookie-policy/">Cookie Policy.</a>
        </p>
    </li>
...
export const Head = () => <title>PrivacyPolicy Page</title>