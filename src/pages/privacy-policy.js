...
const PrivacyPolicyPage = () => {
  return (
    <main style={pageStyles}>
      ...
      <div>
        <br />
        <span>Last Updated On 25-Aug-2023</span>
        <br />
        <span>Effective Date 10-Aug-2023</span>
      </div>

      <p className="privacy-policy-p">
        This Privacy Policy describes the policies of Mozilor, hyfgty, Kerala
        678930, American Samoa, email: haalah+45@mozilor.com, phone: 9876543210
        on the collection, use and disclosure of your information that we
        collect when you use our website (
        https://created-gatsby-site.vercel.app ). (the “Service”). By accessing
      ...
      <ol className="privacy-policy-ol">
        ...
        <li>
          ...
          <p className="privacy-policy-p">
            ...
            exercise these rights, you can write to us at haalah+45@mozilor.com.
        ...
        <li>
          ...
          <p className="privacy-policy-p">
            ...
            <a href="https://created-gatsby-site.vercel.app/cookie-policy/">
              Cookie Policy.
            </a>
          </p>
        </li>
        ...
        <li>
          ...
          <p className="privacy-policy-p">
            ...
            Officer at Mozilor, hyfgty, email: haalah+45@mozilor.com. We will
